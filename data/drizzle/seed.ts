...
const movies = [
    ...
    new Movie('Gods of Egypt', new Date(2024, 4, 5), 2016, 0.5),
    new Movie('A Short Film About Killing', new Date(2024, 4, 5), 1988, 1.6),
    new Movie('Madame Web', new Date(2024, 4, 4), 2024, 0.8),
    new Movie('Injustice', new Date(2024, 3, 30), 2021, 0),
    new Movie('The Devil in Miss Jones', new Date(2024, 3, 22), 1973, -0.5),
    new Movie('Big Trouble in Little China', new Date(2024, 3, 22), 1986, -0.5),
